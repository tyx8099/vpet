...
#define LV_DITHER_GRADIENT 0
     ...
     *The increase in memory consumption is (32 bits * object width size) plus 24 bits * object height. Not too much for small objects (e.g. 200*100 is 12kb) but can be an issue for large images.*/
...
#define LV_USE_FS_STDIO 0
    ...
    #define LV_FS_STDIO_PATH ""         /*Set the working directory. File/directory paths will be appended to it. Use "/" if not needed*/
...
#define LV_USE_FS_POSIX 0
    ...
    #define LV_FS_POSIX_PATH ""         /*Set the working directory. File/directory paths will be appended to it. Use "/" if not needed*/
...
#define LV_USE_FS_WIN32 0
    ...
    #define LV_FS_WIN32_PATH ""         /*Set the working directory. File/directory paths will be appended to it. Use "/" if not needed*/
...
/*Show some widget. You might need to enable the widgets above. */
